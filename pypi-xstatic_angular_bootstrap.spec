...
License  : MIT
Requires: pypi-xstatic_angular_bootstrap-python = %{version}-%{release}
Requires: pypi-xstatic_angular_bootstrap-python3 = %{version}-%{release}
...
%package python
Summary: python components for the pypi-xstatic_angular_bootstrap package.
Group: Default
Requires: pypi-xstatic_angular_bootstrap-python3 = %{version}-%{release}

%description python
python components for the pypi-xstatic_angular_bootstrap package.


%package python3
Summary: python3 components for the pypi-xstatic_angular_bootstrap package.
Group: Default
Requires: python3-core
Provides: pypi(xstatic_angular_bootstrap)

%description python3
python3 components for the pypi-xstatic_angular_bootstrap package.
...
pushd ..
cp -a XStatic-Angular-Bootstrap-2.5.0.0 buildavx2
cp -a XStatic-Angular-Bootstrap-2.5.0.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672119494
